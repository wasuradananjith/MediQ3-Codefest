...
public class HelpCurrentNumber extends AppCompatActivity implements View.OnClickListener {
    TextView textBack,textNext;
    ImageView btnPrev,btnNext;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_help_current_number);
    ...
    public void onClick(View v) {
        switch ((v.getId())) {
            case R.id.prev:
                startActivity(new Intent(HelpCurrentNumber.this, HelpHome.class));
            ...
            case R.id.back:
                ...
                break;
            case R.id.forward:
                startActivity(new Intent(HelpCurrentNumber.this, First.class));
