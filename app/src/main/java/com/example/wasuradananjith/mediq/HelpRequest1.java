...
public class HelpRequest1 extends AppCompatActivity implements View.OnClickListener{
    TextView textBack,textNext;
    ImageView btnPrev,btnNext;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_help_request1);
    ...
    public void onClick(View v) {
        switch ((v.getId())) {
            case R.id.prev:
                startActivity(new Intent(HelpRequest1.this, HelpHome.class));
            ...
            case R.id.back:
                ...
                break;
            case R.id.forward:
                startActivity(new Intent(HelpRequest1.this, HelpRequest2.class));
